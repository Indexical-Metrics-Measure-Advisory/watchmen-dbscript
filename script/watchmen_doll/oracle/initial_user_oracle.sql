...
values ('2', 'imma-console', null, '$2b$12$zt6JK0SdYuYr2WSlL7v.iOLFpH67JEhzATMf.MmccEO2GJvrJMheW', '1', 'user', null, sysdate, '1');


insert into USERS (USERID, NAME, NICKNAME, PASSWORD, IS_ACTIVE, ROLE, CREATETIME, LASTMODIFIED, TENANTID)
values ('3', 'imma-super', null, '$2b$12$v5yHhyCW1sxNjZT9NKiIZuQU3mSaoC6CZkjJCgm.CD2sReTrBaOxO', '1', 'superadmin', null, sysdate, '1');
